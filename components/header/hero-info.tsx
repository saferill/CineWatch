...
export const HeroSectionInfo = ({ movie, isTopOne }: { movie: Movie & { logoUrl?: string | null }, isTopOne?: boolean }) => {
  return (
    <div className="container relative z-50 flex h-full flex-col justify-end pb-8 pt-[15vh] sm:pt-[25vh] md:justify-center md:pb-20 md:pt-32 lg:pb-0 lg:pt-40">
      <div className="max-w-2xl flex flex-col items-center md:items-start text-center md:text-left gap-1 md:gap-4 lg:gap-6 mx-auto md:mx-0">
        {isTopOne && (
        ...
        {movie.logoUrl ? (
          <img 
            ...
            className="max-h-[35px] sm:max-h-[50px] md:max-h-[120px] lg:max-h-[160px] w-auto object-contain object-bottom md:object-left md:origin-left drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)]" 
          />
        ) : (
          <h2 className="text-2xl sm:text-4xl font-extrabold tracking-tight drop-shadow-2xl lg:text-7xl text-white">
